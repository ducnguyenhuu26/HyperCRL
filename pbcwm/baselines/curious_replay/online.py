"""Shared PB-CWM preference/CEM composition for Curious Replay-Adapt."""
...
class CuriousReplayOnline:
    """Keep curious dynamics and PB-CWM preference learning as separate paths."""
    ...
    def __init__(
        ...
        self.dynamics = CuriousReplayDynamicsLearner(
            obs_dim=obs_dim,
